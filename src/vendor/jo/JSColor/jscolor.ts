...
var jscolor = {
	...
	detectDir: function () {
		...
		for (var i = 0; i < elemBase.length; i += 1) {
			if (elemBase[i].href) { base = elemBase[i].href; }
		}
	...
	fireEvent: function (el, evnt) {
		...
		if ((<any>document).createEventObject) {
			var ev: any = (<any>document).createEventObject();
			el.fireEvent('on' + evnt, ev);
		} else if (document.createEvent) {
			var ev: any = document.createEvent('HTMLEvents');
	...
	color: function (target, prop) {
		...
		*/
		...
		function drawPicker(x, y) {
			...
			switch (modeID) {
				case 0: p.pad.classList.add('jscolor-hs'); break;
				case 1: p.pad.classList.add('jscolor-hv'); break;
			}
		...
		function redrawPad() {
			...
			switch (modeID) {
				case 0:
					var rgb: any = HSV_RGB(THIS.hsv[0], THIS.hsv[1], 1);
					...
					break;
				case 1:
					var rgb: any, s, c = [THIS.hsv[2], 0, 0];
